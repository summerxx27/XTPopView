...
- (void)btnClick:(UIButton *)btn
{
    ...
    switch (btn.tag) {
        case 0:
        {
            ...
            XTPopTableView *view1 = [[XTPopTableView alloc] initWithOrigin:point Width:200 Height:30 Type:XTTypeOfUpLeft Color:[UIColor colorWithRed:0.2737 green:0.2737 blue:0.2737 alpha:1.0]];
